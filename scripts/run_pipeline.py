...
# package; `parents[1]/src` carries the migration-target `feature_pipeline` namespace (the
# `schemas` shim it once re-exported from was removed in DOC-02). Both entries are dropped
# once the migration finishes and every caller runs from the installed distribution.
